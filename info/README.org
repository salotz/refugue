...
- [[file:./tutorials/README.org][Tutorial]] & [[file:./examples/README.org][Examples]] :: *Learning-oriented* examples for newcomers.
- [[file:./users_guide.org][User's Guide]] :: *Understanding-Oriented* explanation of how to use
  and learn this software.
- [[file:./howtos.org][How-Tos, Tips, & Tricks]] :: *Goal-Oriented* solutions to specific problems.
